    ...
    if (currentStep < questions.length - 1) {
      ...
      const endpoint =
        modelType === 'linearRegression'
          ? 'http://localhost:5000/predict_linear_regression'
          : 'http://localhost:5000/predict_random_forest';
            ...
            {currentQuestion.options.map((option) => (
              <label
                ...
                style={{
                  margin: '5px',
                  padding: '10px',
                  border: (answers[currentQuestion.id] || []).includes(option.value)
                    ? '2px solid blue'
                    : '1px solid gray',
                  cursor: 'pointer',
                }}
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ width: '100%', background: '#f3f3f3', marginBottom: '20px' }}
      >
        <div
